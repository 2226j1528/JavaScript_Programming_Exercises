...
var Player = function (name, health) {
    ...
    // Method to drop the last item in the player's items array
...
var player2 = new Player("Lara", 70);
player2.place = library;
player2.addItem("a magic wand");
player2.addItem("a healing potion");

var player3 = new Player("Eldon", 85);
player3.place = library;
player3.addItem("a shield");
player3.addItem("a battle axe");
...
// Dropping the last item for each player
console.log(player1.dropLastItem());  // Drops "The Sword of Doom"
console.log(player2.dropLastItem());  // Drops "a healing potion"
console.log(player3.dropLastItem());  // Drops "a battle axe"

// Show the updated players' info
player1.showInfo("=");
player2.showInfo("*");
player3.showInfo("#");
