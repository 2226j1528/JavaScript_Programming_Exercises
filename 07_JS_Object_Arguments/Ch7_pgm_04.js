...
var reflected = reflectX(point1);
console.log("Reflecting point1 in the x-axis");
showPoint(reflected);

var rotated = rotate90(point1);
console.log("Rotating point1 by 90 degrees anticlockwise");
showPoint(rotated);
